...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::skills::create_skill_from_conversation,
            commands::skills::detect_skill_pattern,
            ...
            // Skills - Sync & Sandbox (Phase 9)
            commands::skills::list_importable_skills,
            commands::skills::import_skill_from_repo,
            commands::skills::check_skill_updates,
            commands::skills::sync_skill,
            commands::skills::grant_skill_trust,
            commands::skills::revoke_skill_trust,
            commands::skills::get_skill_trust_state,
            commands::skills::execute_skill_sandboxed,
            // Integrations
